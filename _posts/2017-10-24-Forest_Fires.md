...
This process of cleaning and unifying messy data sets is called "data wrangling", and it frequently comprises the bulk of the effort involved in real world machine learning.
