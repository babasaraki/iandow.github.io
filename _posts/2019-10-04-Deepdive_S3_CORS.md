...
<img src="http://iandow.github.io/img/upload1.gif" width="30%">
3. The second request is an HTTP POST to /upload. The Lambda function responds with said presigned URL.
<img src="http://iandow.github.io/img/upload2.gif" width="30%">
